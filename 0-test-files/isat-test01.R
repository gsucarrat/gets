...
##as of 17 July 2019, these do not work (predict.isat):
predict(isatmod, newmxreg=matrix(0,12,3))
predict(isatmod, n.ahead=1, newmxreg=matrix(0,1,3))
predict(isatmod, newmxreg=matrix(0,12,3), newindex=13:24) #creates bug in plot, but not in predictions
predict(isatmod, newmxreg=matrix(0,12,3), return=FALSE)
predict(isatmod, newmxreg=matrix(0,12,3), plot=FALSE)
predict(isatmod, newmxreg=matrix(0,12,3), return=FALSE, plot=FALSE)
terminals(isatmod)
